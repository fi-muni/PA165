...
public class MainJavaSe {
	...
	private static void task07() {
		...
		// * java.util.Date addedDate - this will be only date field, use
		// @Temporal annotation
		...
		//
		// Additional task: Change the underlying table of Product entity to be
		// ESHOP_PRODUCTS. After you do this, check this by
		// inspecting console output (the CREATE TABLE statement)
		...
		assertEq(cal.get(Calendar.DAY_OF_MONTH), 11);
